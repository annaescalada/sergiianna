...
function Countdown() {
  ...
  if (diff === 0) return <p className="section-label text-sage">Avui és el gran dia!</p>
  return <p className="section-label text-sage">Queden {diff} dies</p>
}

export default function HeroSection() {
  return (
    <section id="hero" className="bg-ivory overflow-hidden">
      ...
      <div className="relative pt-24 pb-10 px-8 text-center max-w-sm mx-auto">
        ...
        <div className="flex items-center justify-center gap-3 mb-2 fade-up fade-up-1">
          <span className="font-serif text-6xl font-light text-forest">{BRIDE_INITIAL}</span>
          <span className="w-px h-12 bg-sage-light"/>
          <span className="font-serif text-6xl font-light text-forest">{GROOM_INITIAL}</span>
        </div>
      ...
      <div className="w-full max-w-sm mx-auto px-4 mb-10">
        {PHOTO_COUPLE ? (
          ...
          <div className="w-full aspect-[3/4] bg-gradient-to-b from-sage-pale to-ivory-dark flex items-center justify-center">
      ...
      <div className="relative px-8 text-center max-w-sm mx-auto pb-16">
        ...
        <p className="font-serif text-sage text-sm mb-1 fade-up fade-up-1">i</p>
        ...
        {/* Script names */}
        <h1 className="font-script text-7xl text-forest leading-tight fade-up fade-up-2">{BRIDE}</h1>
        <p className="font-script text-5xl text-sage mb-1 fade-up fade-up-3">&amp;</p>
        <h1 className="font-script text-7xl text-forest leading-tight mb-10 fade-up fade-up-3">{GROOM}</h1>
        ...
        <div className="flex items-center justify-center gap-4 mb-4 fade-up fade-up-4">
          ...
          <div className="text-center">
            ...
            <p className="font-serif text-5xl font-light text-forest leading-none my-1">{WEDDING_DAY_NUM}</p>
