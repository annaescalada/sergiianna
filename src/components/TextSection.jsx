  ...
  return (
    <section id="intro" className="bg-sand-pale py-20 px-8">
      <div className="max-w-sm mx-auto text-center">
        ...
        <p className="font-serif italic text-stone text-base leading-relaxed mb-5">
          Volem celebrar-ho acompanyats de la nostra família, sense gaires protocols, de manera senzilla i íntima. No us enganyarem, en algun moment hem tingut la temptació de casar-nos i no dir-li a ningú, ja ens coneixeu, però sabem que el nostre dia serà molt millor si el compartim amb vosaltres.
        </p>
